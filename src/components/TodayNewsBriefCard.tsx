    ...
    typeof document !== "undefined"
      ? createPortal(
          <AnimatePresence>
            {open ? (
              <motion.div
                key="today-news-brief-page"
                className="fixed inset-0 z-[200] flex flex-col bg-kindle-bg text-kindle-text sm:bg-black/60 sm:items-center sm:justify-center sm:p-4"
                style={{
                  width: "100vw",
                  height: "100dvh",
                  maxHeight: "100dvh",
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative flex flex-col w-full h-full min-h-0 overflow-hidden bg-kindle-bg kora-safe-top kora-safe-bottom sm:h-auto sm:max-h-[88vh] sm:max-w-lg sm:rounded-2xl sm:border sm:border-kindle-border sm:bg-kindle-card sm:shadow-2xl"
                  initial={reduceMotion ? { opacity: 0 } : { opacity: 0.96, y: 24 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={reduceMotion ? { opacity: 0 } : { opacity: 0.96, y: 32 }}
