...
export default function OnboardingModal({
  ...
  const walkthroughSteps = [
    {
      title: "Interactive tours, not walls of text",
      desc: "After setup, Guides take you to real tabs — Discover, Library, Read, Tools — and spotlight the controls. You tap, search, and open panels yourself.",
      icon: Sofa,
      color: "text-kindle-accent",
      bg: "bg-kindle-accent/10",
      tips: [
        "Lounge Guides restart any unfinished tour anytime.",
        "A setup popup handles reading prefs (font & page turn) during the Sync tour.",
      ],
    },
    {
      title: "Library & Discover",
      desc: "Search Discover to download, then open books from Library. Progress, highlights, and notes stay with each title.",
      icon: BookOpen,
      color: "text-emerald-500",
      bg: "bg-emerald-500/10",
      tips: [
        "The first-book guide waits for your search and download.",
        "Annotations Hub collects highlights across books.",
      ],
    },
    {
      title: "News & Tools",
      desc: "Read holds your feeds and Daily Brief. Tools covers Sync, Read Aloud conversions, and imports — guides open the right panel for you.",
      icon: Rss,
      color: "text-sky-500",
      bg: "bg-sky-500/10",
      tips: [
        "Manage Sources opens from the news guide when you need custom RSS.",
        "Skip any guide forever from the spotlight × if you already know it.",
      ],
    },
    {
      title: "Reader studio",
      desc: "Inside a book: gear for display, headphones for Narrator, long-press for highlights and dictionary.",
      icon: Headphones,
      color: "text-amber-500",
      bg: "bg-amber-500/10",
      tips: [
        "Reader tour starts once you open an EPUB.",
        "Same setup popup prefs apply in-book.",
      ],
    },
  ];
