...
export const GUIDE_CATALOG: GuideDefinition[] = [
  {
    ...
    blurb: "Open Getting started with Kora — spotlights walk you through settings, Narrator, and highlights; finish the last chapters in the book.",
    icon: "book",
    journey: true,
    loungeWidget: true,
    steps: [
      ...
      },
      {
        ...
        body: "Follow the spotlights as you read. We'll walk through settings, Voice Narrator, and highlights — then you finish the guide by scrolling to the last chapters.",
      ...
      },
      {
        ...
        body: "Long-press a word on the page, then choose Highlight (or Note / Dictionary). That ends the spotlight tour — scroll on to finish reading the guide.",
        target: '[data-guide="reader-surface"]',
        placement: "top",
        action: "wait-event",
