...
export const GUIDE_CATALOG: GuideDefinition[] = [
  {
    ...
    blurb: "Open Getting started with Kora — spotlights walk you through settings and Narrator; finish the last chapters in the book.",
    icon: "book",
    journey: true,
    loungeWidget: true,
    steps: [
      {
        ...
        body: "Tap Getting started with Kora on your shelf — the interactive tour continues inside the reader.",
      ...
      },
      {
        ...
        body: "Follow the spotlights as you read. We'll walk through settings and Voice Narrator — then scroll the last chapters to finish.",
      ...
      },
      {
        ...
        body: "Tap headphones to hear this page read aloud. That ends the spotlight tour — scroll on to finish the guide.",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        id: "reader-notes",
        title: "Annotate",
        body: "Tap the highlighter to enter select mode — then pick text for highlights, notes, or dictionary.",
        target: '[data-guide="reader-annotate-btn"]',
        action: "tap-target",
      },
      {
        id: "reader-select",
        title: "Try a selection",
        body: "With annotate on, select a word — highlight, note, or look it up. That finishes this tour.",
        action: "wait-event",
